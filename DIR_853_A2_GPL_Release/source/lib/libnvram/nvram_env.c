...
static block_t fb[FLASH_BLOCK_NUM+EXTEND_BLOCK_NUM] =
{
...
#endif
	{
		...
		.flash_offset =  0x2000,
#if (defined CONFIG_DEFAULTS_MEDIATEK_DIR_882) || (defined CONFIG_DEFAULTS_MEDIATEK_DIR_878) || (defined CONFIG_DEFAULTS_MEDIATEK_DIR_882_PARSE_2) || (defined CONFIG_DEFAULTS_MEDIATEK_DIR_878_PARSE_2) || (defined CONFIG_DEFAULTS_MEDIATEK_DIR_867) || (defined CONFIG_DEFAULTS_MEDIATEK_DIR_853_A2) || (defined CONFIG_DEFAULTS_MEDIATEK_DIR_853_A1)
...
{
    return nvram_get(RT2860_NVRAM,name);
}

int nvram_get_int(char *name)
{
	return atoi(nvram_get(RT2860_NVRAM,name));
}
...
int nvram_safe_set(char *name, char *value)
{
	...
	int index = RT2860_NVRAM;

	if(name == NULL || value == NULL) {
        return -1;
	}

	return nvram_bufset(index, name, value);
}
...
{
	char * value = NULL;
	value = nvram_get(RT2860_NVRAM,name);		 
