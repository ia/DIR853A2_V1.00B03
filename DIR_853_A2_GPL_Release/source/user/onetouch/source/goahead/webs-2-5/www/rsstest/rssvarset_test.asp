...
<body>
<h1>RssVarSet Upload Test</h1>
<form ENCTYPE="multipart/form-data" method="POST" name="uiPostUpdateForm" id="uiPostUpdateForm" action="rssvarset.xgi">
